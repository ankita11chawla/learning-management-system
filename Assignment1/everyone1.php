    	...
    	<div id="pic_manu">
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="">Students</a>
                    ...
                    <ul>
                        <li id="li_submenu">
                        <a href="everyone1.php?tag=student_entry" class="sales">Students Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_students1" class="stocks">View Students</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Teachers</a>
                    ...
                    <ul>
                        <li id="li_submenu">
                        <a href="everyone1.php?tag=teachers_entry" class="order">Teachers Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_teachers" class="stocks">View Teachers</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="">Faculties</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="everyone1.php?tag=faculties_entry" class=" order">Faculties Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_faculties" class="customer">View Faculties</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Subjects</a>
                    ...
                    <ul>
                    	<li id="li_submenu"><a href="everyone1.php?tag=subject_entry" class=" customer">Subjects Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_subjects" class=" customer">View Subjects</a></li>
                    </ul>
           ...
           <li id="li_menu"><a href="">Score</a>
                    ...
                    <ul>
                        ...
                        <li id="li_submenu"><a href="everyone1.php?tag=score_entry" class="customer"> Score Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_scores1" class="order">View Score</a></li>
                    </ul>
                ...
                <li id="li_menu" style="border-right:#CCC"><a href="">Users</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="everyone1.php?tag=susers_entry" class="customer">Users Entry</a></li>
                        <li id="li_submenu"><a href="everyone1.php?tag=view_users" class="sales">View Users</a></li>
